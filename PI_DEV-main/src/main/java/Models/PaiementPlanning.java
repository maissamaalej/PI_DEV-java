...
public class PaiementPlanning {
    ...
    private EtatPaiementPlan etatPaiementPlan;
    private LocalDate date_paiement;

    public PaiementPlanning() {}

    public PaiementPlanning(int id_paiement, int id_planning, int id_adherent, EtatPaiementPlan etatPaiementPlan, LocalDate date_paiement) {
    ...
    public PaiementPlanning( int id_planning, int id_adherent, EtatPaiementPlan etatPaiementPlan, LocalDate date_paiement) {
        this.id_planning = id_planning;
        this.id_adherent = id_adherent;
        this.etatPaiementPlan = etatPaiementPlan;
        this.date_paiement = date_paiement;
    ...
    public EtatPaiementPlan getEtatPaiementPlan(){ return etatPaiementPlan; }
