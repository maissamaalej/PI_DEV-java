...
public class Reclamation {
    ...
    private Models.typeR type;
    private int id_coach;
    private int id_adherent;
    private Date date;

    // Constructeur
    public Reclamation(int idReclamation, String description, Models.typeR type, int id_coach, int id_adherent, Date date) {
    ...
    public Models.typeR getType() { return type; }
